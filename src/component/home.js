    ...
    return /^[a-zA-Z\s]+$/.test(name) && name.trim().length > 0;
     ...
     async function fetchData() {
        ...
        try {
            ...
            console.log( "weather data:",Apidata.main.temp);
        ...
        <div>
           ...
           {Apidata &&  !loading && !error &&  (
            <div className="weather-info">
             ...
             {showGif && 
                    <img height= {100} width={200} src="https://i.pinimg.com/originals/96/3f/2f/963f2ffa6f7df91ab4ae0fb4f3ee2cf9.gif" alt="brahmmi" ></img>
                }
